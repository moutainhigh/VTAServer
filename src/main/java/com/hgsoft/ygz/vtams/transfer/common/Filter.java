...
public class Filter implements Serializable {
    ...
    public Criterion getCriteria() {
        ...
        Criterion result = Restrictions.eq(property, value);
        switch (this.operator) {
            case eq:
                if (StringUtils.endsWith(property, "id")) {
                    result = Restrictions.eq(property, Long.parseLong((String) value));
                } else {
            ...
            case isNull:
                ...
                break;
            case isNotNull:
                result = Restrictions.isNotNull(property);
                break;
            case lt:
                result = Restrictions.lt(property, value);
                break;
            case like:
                result = Restrictions.like(property, value);
                break;
            default:
                break;
        }
